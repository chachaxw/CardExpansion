...
var demo = (function(window, undefined){
   ...
   */
    function _mapPolygons(pattern){
        ...
        polygonMap.paths.forEach(function(polygon){
            ...
            $(polygon).attr('class', CLASSESS.polygon + '' + CLASSESS.patternHidden);
        ...
        $(SELECTORS.pattern).removeClass(CLASSESS.polygonHidden);
    };
   ...
   */
    function _playSequence(isOpenClick, id, e){
        ...
        var sequence = new TimelineLite({pasued: true});
    ...
    function _onCardMove(track){
        ...
        polygonMap.points.forEach(function(point, i){
            if(_detectPointInCircle(point, radius, center))
                $(polygonMap.paths[i]).attr('class', CLASSESS.polygon);
            else
                $(polygonMap.paths[i]).attr('class', CLASSESS.polygon + '' + CLASSESS.polygonHidden);
        });
    };
